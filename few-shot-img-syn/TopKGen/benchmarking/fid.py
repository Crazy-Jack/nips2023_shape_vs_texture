...
if __name__ == '__main__':
    ...
    parser.add_argument('--iter', type=float, default=3)
    parser.add_argument('--end', type=int, default=13)

    args = parser.parse_args()


    # for i in range(args.iter, args.iter+1):
    i = args.iter
    print(f"---------- iter {i * 10000} ------------")
    path_b = os.path.join(args.path_b, f'eval_{int(i * 10000)}', 'img')
