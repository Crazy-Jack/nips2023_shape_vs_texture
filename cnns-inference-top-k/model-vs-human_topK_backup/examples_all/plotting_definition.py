...
def plotting_definition_template(df):
    ...
    decision_makers.append(DecisionMaker(name_pattern="AlexNet_topK_5_Revert",
                        color=rgb(210, 210, 80), marker="X", df=df,
                        plotting_name="sparseAlexNet_5%_reverse"))

    decision_makers.append(DecisionMaker(name_pattern="AlexNet_topK_10_Revert",
                        color=rgb(180, 180, 70), marker="X", df=df,
                        plotting_name="sparseAlexNet_10%_reverse"))

    decision_makers.append(DecisionMaker(name_pattern="AlexNet_topK_20_Revert",
                        color=rgb(130, 130, 55), marker="X", df=df,
                        plotting_name="sparseAlexNet_20%_reverse"))

    decision_makers.append(DecisionMaker(name_pattern="AlexNet_topK_30_Revert",
                        color=rgb(100, 100, 50), marker="X", df=df,
                        plotting_name="sparseAlexNet_30%_reverse"))
    
    decision_makers.append(DecisionMaker(name_pattern="AlexNet_topK_40_Revert",
                        color=rgb(70, 70, 45), marker="X", df=df,
                        plotting_name="sparseAlexNet_40%_reverse"))

    decision_makers.append(DecisionMaker(name_pattern="AlexNet_topK_50_Revert",
                        color=rgb(30, 30, 40), marker="X", df=df,
                        plotting_name="sparseAlexNet_50%_reverse"))
